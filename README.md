...
这是一个面向全国大学生电子设计竞赛 H 题的车载平衡滚球运动控制系统。本项目并不十分完美，创新分没有拿满，可以进行学习参看。下面大部分文档由AI总结的。(求点星星)

小车沿黑色环形轨迹自主行驶，车载摆杆中放置钢球，通过K230摄像头实时获取钢球位置，再由舵机调节摆杆角度，使钢球在静止或行驶过程中保持在目标位置附近。（注意！！！本人的K230识别小球的帧率有55帧左右，30帧左右的识别小球位置是否能够达到一样的满分效果本代码还未试验）

项目以 TI MSPM0G3507 为主控制器，结合红外循迹、电机编码器、IMU、视觉位置检测和 OLED 显示。大部分结构都是买的轮趣的，想要快速复刻可以买买看（本人只是推荐）。有什么想要交流的可以联系qq邮箱:3114188569@qq.com
